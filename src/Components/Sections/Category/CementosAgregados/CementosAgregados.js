...
const CementosAgregados = [
    ...
    { id: 18, name: "Gravilla Cafe 1 x 50 kg", image: argos19, description: "La grava o gravilla es roca molida (natural o artificial) que puede ser de varios tamaños que van desde los 2 hasta los 64 milímetros de grosor, este agregado se puede clasificar en fina, media y gruesa." },
    { id: 19, name: "Gravilla Café 2 x 50 kg", image: argos20, description: "La grava o gravilla es roca molida (natural o artificial) que puede ser de varios tamaños que van desde los 2 hasta los 64 milímetros de grosor, este agregado se puede clasificar en fina, media y gruesa." },
    { id: 20, name: "Gravilla Gris 1 x 23 kg", image: argos21, description: "La grava o gravilla es roca molida (natural o artificial) que puede ser de varios tamaños que van desde los 2 hasta los 64 milímetros de grosor, este agregado se puede clasificar en fina, media y gruesa." },
    { id: 21, name: "Gravilla Gris 2 x 23 kg", image: argos22, description: "La grava o gravilla es roca molida (natural o artificial) que puede ser de varios tamaños que van desde los 2 hasta los 64 milímetros de grosor, este agregado se puede clasificar en fina, media y gruesa." },
    { id: 22, name: "Gravilla Mona x 23 kg", image: argos23, description: "La grava o gravilla es roca molida (natural o artificial) que puede ser de varios tamaños que van desde los 2 hasta los 64 milímetros de grosor, este agregado se puede clasificar en fina, media y gruesa." },
    { id: 23, name: "Pieadra Jardin Blanca", image: roca, description: "Los agregados, son materiales granulares e inertes, de origen natural o por un proceso de trituración a partir de rocas. Constituyen entre el 65% y el 85% del volumen total del Concreto; además, constituyen aproximadamente el 95% de las mezclas asfálticas." },
