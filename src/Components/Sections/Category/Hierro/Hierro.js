...
const Hierro = [
    ...
    { id: 2, name: "Chipa Corrugada", image: hierro2, secondImage: hierro5, description: "Chipa: 1/4, 3/8, 1/2, 5/8" },
    { id: 3, name: "Malla Electrosoldada", image: hierro3, secondImage: hierro6, description: "Malla electrosoldada 15x15 de 6 mts: 4 mm 5 mm, Rollo Malla electrosoldada 15x15 de 18 mts: 3.5 mm 4 mm" },
    { id: 4, name: "Alambre Negro", image: hierro7, description: "1 kg, 2 kg, 3 kg, 5 kg" },
    { id: 5, name: "Alambre Galvanisado", image: hierro8, description: "1 kg, 2 kg, 3 kg, 5kg" }
];
