...
import Productos from '../../Products/ArrayProducts/Products';
import Footer from '../../Layouts/Footer/Footer';

const HomeMain = ({ searchTerm = "" }) => {
    ...
    return (
        <>
            ...
            >
                ...
                <h1 className="relative text-white text-4xl font-bold p-4 rounded-lg z-10 sm: ml-4">
                    Catálogo
                </h1>
            </div>
                            ...
                            <div className="bg-white p-6 rounded-lg w-full max-w-lg lg:max-w-4xl flex flex-col lg:flex-row relative">
                                ...
                                <div className="lg:w-1/2 flex justify-center items-center">
                                    <img
                                        ...
                                        className="w-full h-[150px] object-contain mb-4 lg:mb-0 sm:h-[400px] lg:h-[400px]"
                                    />
                                </div>
                                ...
                                <div className="lg:w-1/2 lg:pl-6">
                                    ...
                                    {selectedProduct.colorLink && (
                                        <a
                                            href={selectedProduct.colorLink}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="bg-[#ACC90F] hover:bg-[#adc90fbb] text-white px-4 py-2 rounded w-full block text-center mb-4"
                                        >
